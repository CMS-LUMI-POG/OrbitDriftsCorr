...
STR_OD_JSONS=("arcBPM" "DOROS" "arcBPM_DOROS_ave" "arcBPM_m_DOROS")
...
do
    ...
    for STR_OD_JSON in ${STR_OD_JSONS[@]};
    do
        mv  OrbitDrifts_${STR_OD_JSON}.json ${STR_NAME_OD_JSON}_${STR_OD_JSON}.json
    done
